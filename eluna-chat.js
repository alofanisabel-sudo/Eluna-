...
// Elle reçoit l'historique de conversation, appelle l'API Gemini (gratuite)
// avec la clé secrète (stockée dans les variables d'environnement Netlify,
// jamais dans le code), et renvoie juste le texte de la réponse au navigateur.
...
exports.handler = async (event) => {
  ...
  // Gemini utilise "model" au lieu de "assistant" pour ses propres réponses
